...
<div className="row text-center my-3 justify-content-center "> 
 <div className="col-8  ">
  <input type="text" className='mx-2  col-lg-4' placeholder=' First Name' />
  <input type="text" className='mx-2 col-lg-4' placeholder=' Last Name' />
</div>
</div>
...
<div className="col-8 px-1 ">
  <input type="text" className='col-lg-6 ' placeholder='Enter Your Email ' />
 <input type="submit" className=' col-lg-2 submitButton' value="Subscribe" />
</div>
</div>
